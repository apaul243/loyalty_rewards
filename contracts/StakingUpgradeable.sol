 ...
 *      Contract supports two different rate modes: fixed APR and dynamic APR.
 **/
...
contract StakingUpgradeable is Initializable,OwnableUpgradeable,PausableUpgradeable  {
    ...
    uint public fixedRate; // between 1 to 10000, where apr %  = fixedRate/10000
    ...
    function initialize (address _stakingToken, address _rewardToken, address _vault,uint _fixedRate, bool ifCompounding) public initializer{
